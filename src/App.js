...
import imgMatic from "./icons8-matic-50.png";

const ethAmount = "30";
const image =
  "https://pbs.twimg.com/profile_images/1658751614474244098/g5Ib4H-F_400x400.jpg";
      ...
      <div className="App">
        ...
        <div>
          <div className="amount">
            Amount - {ethAmount} <img className="matic" src={imgMatic} alt="" />
          </div>
